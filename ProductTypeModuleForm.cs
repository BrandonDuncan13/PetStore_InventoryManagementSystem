...
{
    public partial class ProductTypeModuleForm : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    command = new SqlCommand("INSERT INTO [Category](categoryname)Values(@categoryname)", connection);
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    command = new SqlCommand("UPDATE [Category] SET categoryname=@categoryname WHERE categoryid LIKE '" + lblCategoryId.Text + "'", connection);
                    command.Parameters.AddWithValue("@categoryname", txtCategoryName.Text);
                    // open connection to database
                    connection.Open();
                    // execute the insert
